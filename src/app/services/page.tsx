        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              We offer three comprehensive Bitcoin payment solutions tailored to the needs of Jacksonville businesses, from simple on-chain payments to full nodes with Lightning capabilities.
            </p>
          </motion.div>
